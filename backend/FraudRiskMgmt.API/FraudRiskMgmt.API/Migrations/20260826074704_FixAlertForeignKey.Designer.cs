...
namespace FraudRiskMgmt.API.Migrations
{
    ...
    [Migration("20260826074704_FixAlertForeignKey")]
    partial class FixAlertForeignKey
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FraudRiskMgmt.API.Models.Cases", b =>
                {
                    ...
                    b.Property<int>("OpenedByUserUserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FraudRiskMgmt.API.Models.Cases", b =>
                {
                    ...
                    b.HasOne("FraudRiskMgmt.API.Models.User", "OpenedByUser")
                        .WithMany()
                        .HasForeignKey("OpenedByUserUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
